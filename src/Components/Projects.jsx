...
const portfolios = [
  {
    ...
    desc: "Lorem ipsums dolor sit amet, consectetur adipiscing elit. Felis magnis donec vitae eu vel volutpat leo mauris.",
  },
  {
    id: 2,
    img: hrApp,
      ...
      <div className="w-[80%] mx-auto">
        <div className=" flex flex-col gap-10 -mt-[100px]">
          <div className="flex flex-col gap-4 pt-10">
            ...
            <p className="capitalize text-sm text-white font-normal">
            ...
            {portfolios.map(({ id, img, smalltxt, guest, desc }) => (
              <div key={id} className="flex flex-col gap-[30px]">
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-[#5A5A5A] text-sm font-normal capitalize leading-[17.64px]">
                    <li>{smalltxt}</li>
                  </span>
                  <div className="max-w-[416px]">
                    <p className="text-white capitalize text-xl leading-[25.2px]">
                      {guest}
                    </p>
                  </div>
                  <div>
